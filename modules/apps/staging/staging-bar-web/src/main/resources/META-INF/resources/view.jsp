										...
										<c:choose>
											<c:when test="<%= branchingEnabled %>">
												...
												<li class="control-menu-nav-item staging-bar-level-2-nav-item">
													...
													<liferay-util:include page="/view_workflow_status.jsp" servletContext="<%= application %>" />
												</li>
												<li class="nav-item-flex-end staging-bar-level-2-nav-item staging-layout-revision-details" id="<portlet:namespace />layoutRevisionDetails">
													<aui:model-context bean="<%= layoutRevision %>" model="<%= LayoutRevision.class %>" />
